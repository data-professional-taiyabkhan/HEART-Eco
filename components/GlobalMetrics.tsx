...
export default function GlobalMetrics() {
  ...
  if (!metrics) {
    return (
      <div className="bg-gradient-to-r from-brand-600 to-blue-600 text-white py-4 shadow-lg">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[1, 2, 3].map((i) => (
              <div key={i} className="flex flex-col items-center md:items-start animate-pulse">
                <div className="h-4 bg-brand-400 rounded w-24 mb-2"></div>
                <div className="h-8 bg-brand-400 rounded w-32"></div>
              </div>
            ))}
          </div>
        </div>
  ...
  return (
    <div className="bg-gradient-to-r from-brand-600 to-blue-600 text-white shadow-lg">
      <div className="container mx-auto px-4 py-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="flex flex-col items-center md:items-start">
            <span className="text-sm font-medium text-brand-100 uppercase tracking-wide">
              Global GDP
            </span>
